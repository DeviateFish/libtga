(function (global, factory) {
  ...
  var IMAGE_TYPE_NONE = 0 | 0;
  var IMAGE_TYPE_COLORMAPPED = 1 | 0;
  var IMAGE_TYPE_TRUECOLOR = 2 | 0;
  var IMAGE_TYPE_GREYSCALE = 3 | 0;

  // compression flag:
  var IMAGE_RUNLENGTH_ENCODED = 0x8 | 0;
  ...
  var IMAGE_DESCRIPTOR_ATTRIBUTE_MASK = 0xf;
  var IMAGE_DESCRIPTOR_ORIGIN_MASK = 0x30;
  var IMAGE_DESCRIPTOR_INTERLEAVE_MASK = 0xc0;

  // Origin values:
  var IMAGE_ORIGIN_VERTICAL_MASK = 0x02;
  var IMAGE_ORIGIN_HORIZONTAL_MASK = 0x01;
  var IMAGE_ORIGIN_TOP = 0x02;
  var IMAGE_ORIGIN_RIGHT = 0x01;

  var TGA = function TGA(arraybuf) {
    _classCallCheck(this, TGA);
  ...
  TGA.readColormappedImage = function (tga) {
    var dataview = tga.dataview,
        ...
        offset = HEADER_SIZE + header.idLength + header.colorMapSpec.length * header.colorMapSpec.entrySizeBytes,
  ...
  // Base function.
  var libtga = {
    readFile: function readFile(arraybuf) {
